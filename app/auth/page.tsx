      ...
      <div className="sarthi-card p-4 sm:p-6 space-y-4 rounded-[16px]">
        ...
        <div className="flex bg-[#2a2a2a] rounded-[16px] p-1">
          <button
            ...
            className={`flex-1 py-2 px-3 rounded-[12px] text-sm font-medium transition-all duration-150 ${contactType === "email" ? "bg-white text-[#0f0f0f]" : "text-[#cbd5e1] hover:text-white hover:bg-white/10"
              }`}
          >
            Email
          </button>
          <button
            ...
            className={`flex-1 py-2 px-3 rounded-[12px] text-sm font-medium transition-all duration-150 ${contactType === "phone" ? "bg-white text-[#0f0f0f]" : "text-[#cbd5e1] hover:text-white hover:bg-white/10"
              }`}
          >
            Phone
          </button>
