    ...
    <div className="min-h-screen bg-[#121212] flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md space-y-6 sm:space-y-8">
        <div className="text-center space-y-3 sm:space-y-4">
          ...
          <h1 className="text-2xl sm:text-3xl font-light text-white">You did something brave today.</h1>
          <p className="text-base text-white/60 sm:text-lg">Thank you for trusting me with your words. How do you feel now?</p>
        </div>
